...
class BandMembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create band_member" do
    assert_difference('BandMember.count') do
      post band_members_url, params: { band_member: { artist_id: @band_member.artist_id, instrument: @band_member.instrument, name: @band_member.name } }
    end
  ...
  test "should update band_member" do
    patch band_member_url(@band_member), params: { band_member: { artist_id: @band_member.artist_id, instrument: @band_member.instrument, name: @band_member.name } }
